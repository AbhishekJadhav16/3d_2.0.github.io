...
const App = () => {
  ...
  useEffect(() => {
    const typingTimeout = setTimeout(() => setShowTyping(false), 3500); // Show full text and wait for 1 second after "Jadhav"
    const dragTimeout = setTimeout(() => setShowDragScreen(true), 4500);
      ...
      <main className={`min-h-screen relative flex justify-center items-center ${showContent ? "bg-transparent" : "bg-black"}`}>
        {showLoadingScreen && (
          ...
          >
            ...
            {showTyping && (
              <motion.h1
                className="text-white text-[12vw] sm:text-[8vw] md:text-[6vw] lg:text-[5vw] font-bold leading-tight text-center z-10"
                initial={{ opacity: 1 }}
            ...
            {/* Drag and Arrow Key Prompt */}
            {showDragScreen && (
              <motion.div
                className="text-white text-lg sm:text-xl flex flex-col items-center px-6 py-3 rounded-lg text-center z-10"
            ...
            {showFinalLoading && (
              <motion.p
                className="text-white text-lg sm:text-xl px-6 py-3 rounded-lg text-center z-10"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
